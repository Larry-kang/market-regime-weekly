...
| 項目 | 數值 | 解讀 |
|---|---|---|
| 最新收盤 | 4.81（2026-09-08） | 資料截至 2026-09-08（市場休市或尚未更新） |
| 20D / 50D / 200D MA | 4.72 / 4.64 / 4.36 | 日線均線位置 |
| 20W / 50W / 200W MA | 4.58 / 4.33 / 4.18 | 週線均線位置 |
| 距 200W MA | 0.62 點（+14.87%） | 距離長週線的乖離 |
| 日線 RSI(14) | 62.1，中性偏強 | 短線動能 |
| 日報短線 overlay | 偏多整理 | 信心：中 |
| 7 日報酬 / 成交量比 | +1.82% / N/A | 短線動能與量能；量比為最近 7 日均值比例 |
| 短線支撐 / 壓力 | 4.65–4.79 / 4.81–4.81 | 最近 7 日價格區間與均線 |
| 日線 MACD(12,26,9) | MACD 線高於訊號線，柱狀體正0.01，較前值擴大 | 日線趨勢 |
| 週線 RSI(14) | 65.8，中性偏強 | 中週期動能 |
| 週線 MACD(12,26,9) | MACD 線高於訊號線，柱狀體正0.02，較前值收斂 | 週線趨勢 |

## 日線觀察
- RSI 62.1，中性偏強；MACD 線高於訊號線，柱狀體正0.01，較前值擴大
- **日報式短線判斷**：偏多整理；支撐約 4.65–4.79，壓力約 4.81–4.81。
- 日線目前偏向 中性偏強 區，代表短線動能已經有方向，但未必足以單獨當作進場依據。
- 若日線 MACD 柱狀體持續收斂，通常表示短線壓力正在減輕；若擴大，代表還要再等。

## 週線觀察
- RSI 65.8，中性偏強；MACD 線高於訊號線，柱狀體正0.02，較前值收斂
