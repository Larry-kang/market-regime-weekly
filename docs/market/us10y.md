...
| 項目 | 數值 | 解讀 |
|---|---|---|
| 最新收盤 | 4.66（2026-08-27） | 最新可用收盤價 |
| 20D / 50D / 200D MA | 4.68 / 4.60 / 4.34 | 日線均線位置 |
| 20W / 50W / 200W MA | 4.53 / 4.31 / 4.18 | 週線均線位置 |
| 距 200W MA | 0.49 點（+11.66%） | 距離長週線的乖離 |
| 日線 RSI(14) | 50.7，中性 | 短線動能 |
| 日報短線 overlay | 短線轉弱 | 信心：中 |
| 7 日報酬 / 成交量比 | +0.19% / N/Ax | 短線動能與量能；量比為最近 7 日均值比例 |
| 短線支撐 / 壓力 | 4.62–4.68 / 4.66–4.74 | 最近 7 日價格區間與均線 |
| 日線 MACD(12,26,9) | MACD 線低於訊號線，柱狀體負0.01，較前值擴大 | 日線趨勢 |
| 週線 RSI(14) | 58.9，中性偏強 | 中週期動能 |
| 週線 MACD(12,26,9) | MACD 線高於訊號線，柱狀體正0.01，較前值收斂 | 週線趨勢 |

## 日線觀察
- RSI 50.7，中性；MACD 線低於訊號線，柱狀體負0.01，較前值擴大
- **日報式短線判斷**：短線轉弱；支撐約 4.62–4.68，壓力約 4.66–4.74。
- 日線目前偏向 中性 區，代表短線動能已經有方向，但未必足以單獨當作進場依據。
- 若日線 MACD 柱狀體持續收斂，通常表示短線壓力正在減輕；若擴大，代表還要再等。

## 週線觀察
- RSI 58.9，中性偏強；MACD 線高於訊號線，柱狀體正0.01，較前值收斂
