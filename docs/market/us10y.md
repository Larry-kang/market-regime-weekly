...
| 距 200W MA | 0.55 點（+13.13%） | 距離長週線的乖離 |
| 日線 RSI(14) | 56.7，中性偏強 | 短線動能 |
| 日報短線 overlay | 偏多整理 | 信心：中 |
| 7 日報酬 / 成交量比 | +0.60% / N/Ax | 短線動能與量能；量比為最近 7 日均值比例 |
