...
| 項目 | 數值 | 解讀 |
|---|---|---|
| 最新收盤 | 4.95（2026-09-17） | 資料截至 2026-09-17（市場休市或尚未更新） |
| 20D / 50D / 200D MA | 4.81 / 4.71 / 4.39 | 日線均線位置 |
| 20W / 50W / 200W MA | 4.62 / 4.35 / 4.19 | 週線均線位置 |
| 距 200W MA | 0.76 點（+18.06%） | 距離長週線的乖離 |
| 日線 RSI(14) | 65.3，中性偏強 | 短線動能 |
| 日報短線 overlay | 短線轉弱 | 信心：中 |
| 7 日報酬 / 成交量比 | +2.27% / N/A | 短線動能與量能；量比為最近 7 日均值比例 |
| 短線支撐 / 壓力 | 4.79–4.98 / 4.95–5.02 | 最近 7 日價格區間與均線 |
| 日線 MACD(12,26,9) | MACD 線高於訊號線，柱狀體正0.02，較前值收斂 | 日線趨勢 |
| 週線 RSI(14) | 69.2，中性偏強 | 中週期動能 |
| 週線 MACD(12,26,9) | MACD 線高於訊號線，柱狀體正0.03，較前值擴大 | 週線趨勢 |

## 日線觀察
- RSI 65.3，中性偏強；MACD 線高於訊號線，柱狀體正0.02，較前值收斂
- **日報式短線判斷**：短線轉弱；支撐約 4.79–4.98，壓力約 4.95–5.02。
- 日線目前偏向 中性偏強 區，代表短線動能已經有方向，但未必足以單獨當作進場依據。
- 若日線 MACD 柱狀體持續收斂，通常表示短線壓力正在減輕；若擴大，代表還要再等。

## 週線觀察
- RSI 69.2，中性偏強；MACD 線高於訊號線，柱狀體正0.03，較前值擴大
