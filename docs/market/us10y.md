...
| 項目 | 數值 | 解讀 |
|---|---|---|
| 最新收盤 | 4.58（2026-07-20） | 最新可用收盤價 |
| 20D / 50D / 200D MA | 4.50 / 4.50 / 4.25 | 日線均線位置 |
| 20W / 50W / 200W MA | 4.43 / 4.25 / 4.16 | 週線均線位置 |
| 距 200W MA | 0.43 點（+10.23%） | 距離長週線的乖離 |
...
## 日線觀察
- RSI 58.2，中性偏強；MACD 線高於訊號線，柱狀體正0.01，較前值收斂
