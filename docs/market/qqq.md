...
| 項目 | 數值 | 解讀 |
|---|---|---|
| 最新收盤 | 708.69（2026-09-10） | 資料截至 2026-09-10（市場休市或尚未更新） |
| 20D / 50D / 200D MA | 716.53 / 710.61 / 659.51 | 日線均線位置 |
| 20W / 50W / 200W MA | 712.05 / 651.44 / 486.30 | 週線均線位置 |
| 距 200W MA | 222.39 點（+45.73%） | 距離長週線的乖離 |
| 日線 RSI(14) | 46.3，中性 | 短線動能 |
| 日報短線 overlay | 短線轉弱 | 信心：中 |
| 7 日報酬 / 成交量比 | +0.15% / 1.05x | 短線動能與量能；量比為最近 7 日均值比例 |
| 短線支撐 / 壓力 | 704.66–716.00 / 708.69–721.89 | 最近 7 日價格區間與均線 |
| 日線 MACD(12,26,9) | MACD 線低於訊號線，柱狀體負0.58，較前值擴大 | 日線趨勢 |
| 週線 RSI(14) | 55.5，中性偏強 | 中週期動能 |
| 週線 MACD(12,26,9) | MACD 線低於訊號線，柱狀體負3.61，較前值擴大 | 週線趨勢 |

## 日線觀察
- RSI 46.3，中性；MACD 線低於訊號線，柱狀體負0.58，較前值擴大
- **日報式短線判斷**：短線轉弱；支撐約 704.66–716.00，壓力約 708.69–721.89。
- 日線目前偏向 中性 區，代表短線動能已經有方向，但未必足以單獨當作進場依據。
- 若日線 MACD 柱狀體持續收斂，通常表示短線壓力正在減輕；若擴大，代表還要再等。

## 週線觀察
- RSI 55.5，中性偏強；MACD 線低於訊號線，柱狀體負3.61，較前值擴大
