...
| 項目 | 數值 | 解讀 |
|---|---|---|
| 最新收盤 | 723.03（2026-08-07） | 最新可用收盤價 |
| 20D / 50D / 200D MA | 700.34 / 714.57 / 647.85 | 日線均線位置 |
| 20W / 50W / 200W MA | 686.19 / 638.23 / 475.21 | 週線均線位置 |
| 距 200W MA | 247.82 點（+52.15%） | 距離長週線的乖離 |
| 日線 RSI(14) | 57.1，中性偏強 | 短線動能 |
| 日報短線 overlay | 偏多震盪／接近壓力 | 信心：中 |
| 7 日報酬 / 成交量比 | +5.78% / 0.68x | 短線動能與量能；量比為最近 7 日均值比例 |
| 短線支撐 / 壓力 | 673.30–715.78 / 723.03–728.54 | 最近 7 日價格區間與均線 |
| 日線 MACD(12,26,9) | MACD 線高於訊號線，柱狀體正4.44，較前值擴大 | 日線趨勢 |
| 週線 RSI(14) | 60.7，中性偏強 | 中週期動能 |
| 週線 MACD(12,26,9) | MACD 線低於訊號線，柱狀體負3.12，較前值收斂 | 週線趨勢 |

## 日線觀察
- RSI 57.1，中性偏強；MACD 線高於訊號線，柱狀體正4.44，較前值擴大
- **日報式短線判斷**：偏多震盪／接近壓力；支撐約 673.30–715.78，壓力約 723.03–728.54。
- **資料限制**：RSI(6) 僅作短線提示，不等同標準 RSI(14)。
- 日線目前偏向 中性偏強 區，代表短線動能已經有方向，但未必足以單獨當作進場依據。
- 若日線 MACD 柱狀體持續收斂，通常表示短線壓力正在減輕；若擴大，代表還要再等。

## 週線觀察
- RSI 60.7，中性偏強；MACD 線低於訊號線，柱狀體負3.12，較前值收斂
