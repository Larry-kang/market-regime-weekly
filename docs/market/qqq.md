...
| 項目 | 數值 | 解讀 |
|---|---|---|
| 最新收盤 | 741.47（2026-09-21） | 資料截至 2026-09-21（市場休市或尚未更新） |
| 20D / 50D / 200D MA | 714.64 / 710.27 / 663.20 | 日線均線位置 |
| 20W / 50W / 200W MA | 716.24 / 656.97 / 490.79 | 週線均線位置 |
| 距 200W MA | 250.68 點（+51.08%） | 距離長週線的乖離 |
| 日線 RSI(14) | 65.7，中性偏強 | 短線動能 |
| 日報短線 overlay | 偏多但未確認突破 | 信心：中 |
| 7 日報酬 / 成交量比 | +3.72% / 1.27x | 短線動能與量能；量比為最近 7 日均值比例 |
| 短線支撐 / 壓力 | 700.00–717.82 / 741.47–743.22 | 最近 7 日價格區間與均線 |
| 日線 MACD(12,26,9) | MACD 線高於訊號線，柱狀體正1.83，較前值擴大 | 日線趨勢 |
| 週線 RSI(14) | 63.0，中性偏強 | 中週期動能 |
| 週線 MACD(12,26,9) | MACD 線低於訊號線，柱狀體負1.77，較前值收斂 | 週線趨勢 |

## 日線觀察
- RSI 65.7，中性偏強；MACD 線高於訊號線，柱狀體正1.83，較前值擴大
- **日報式短線判斷**：偏多但未確認突破；支撐約 700.00–717.82，壓力約 741.47–743.22。
- 日線目前偏向 中性偏強 區，代表短線動能已經有方向，但未必足以單獨當作進場依據。
- 若日線 MACD 柱狀體持續收斂，通常表示短線壓力正在減輕；若擴大，代表還要再等。

## 週線觀察
- RSI 63.0，中性偏強；MACD 線低於訊號線，柱狀體負1.77，較前值收斂
