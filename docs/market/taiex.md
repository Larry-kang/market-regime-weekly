...
| 項目 | 數值 | 解讀 |
|---|---|---|
| 最新收盤 | 47,023.13（2026-07-06） | 最新可用收盤價 |
| 20D / 50D / 200D MA | 45,635.28 / 43,515.35 / 33,360.88 | 日線均線位置 |
| 20W / 50W / 200W MA | 39,779.12 / 32,379.93 / 22,244.95 | 週線均線位置 |
| 距 200W MA | 24,778.18 點（+111.39%） | 距離長週線的乖離 |
| 日線 RSI(14) | 60.5，中性偏強 | 短線動能 |
| 日線 MACD(12,26,9) | MACD 線低於訊號線，柱狀體負72.08，較前值收斂 | 日線趨勢 |
| 週線 RSI(14) | 77.1，超買 | 中週期動能 |
| 週線 MACD(12,26,9) | MACD 線高於訊號線，柱狀體正417.71，較前值收斂 | 週線趨勢 |

## 日線觀察
- RSI 60.5，中性偏強；MACD 線低於訊號線，柱狀體負72.08，較前值收斂
- 日線目前偏向 中性偏強 區，代表短線動能已經有方向，但未必足以單獨當作進場依據。
- 若日線 MACD 柱狀體持續收斂，通常表示短線壓力正在減輕；若擴大，代表還要再等。

## 週線觀察
- RSI 77.1，超買；MACD 線高於訊號線，柱狀體正417.71，較前值收斂
